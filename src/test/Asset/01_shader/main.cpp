...
int main() {
  ...
  auto hlslPath = AssetMngr::Instance().GUIDToAssetPath(
      xg::Guid{"d1ee38ec-7485-422e-93f3-c8886169a858"});
  ...
  shader.properties["gAlbedoMap"] = AssetMngr::Instance().LoadAsset<Texture2D>(
      AssetMngr::Instance().GUIDToAssetPath(
          xg::Guid{"1936ed7e-6896-4ace-abd9-5b084fcfb891"}));
  shader.properties["gRoughnessMap"] =
      AssetMngr::Instance().LoadAsset<Texture2D>(
          AssetMngr::Instance().GUIDToAssetPath(
              xg::Guid{"1936ed7e-6896-4ace-abd9-5b084fcfb891"}));
  shader.properties["gMetalnessMap"] =
      AssetMngr::Instance().LoadAsset<Texture2D>(
          AssetMngr::Instance().GUIDToAssetPath(
              xg::Guid{"1936ed7e-6896-4ace-abd9-5b084fcfb891"}));
  shader.properties["gNormalMap"] = AssetMngr::Instance().LoadAsset<Texture2D>(
      AssetMngr::Instance().GUIDToAssetPath(
          xg::Guid{"b5e7fb39-fedd-4371-a00a-552a86307db7"}));
