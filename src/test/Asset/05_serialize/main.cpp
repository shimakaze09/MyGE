...
struct My::MySRefl::TypeInfo<A> : My::MySRefl::TypeInfoBase<A> {
  ...
  static constexpr FieldList fields = {
      Field{"v_bool", &A::v_bool},         Field{"v_uint8", &A::v_uint8},
      Field{"v_uint16", &A::v_uint16},     Field{"v_uint32", &A::v_uint32},
      Field{"v_uint64", &A::v_uint64},     Field{"v_int8", &A::v_int8},
      Field{"v_int16", &A::v_int16},       Field{"v_int32", &A::v_int32},
      Field{"v_int64", &A::v_int64},       Field{"v_nullptr", &A::v_nullptr},
      Field{"v_float", &A::v_float},       Field{"v_double", &A::v_double},
      Field{"v_string", &A::v_string},     Field{"v_entity", &A::v_entity},
...
int main() {
  ...
  a->v_hlslFile = AssetMngr::Instance().LoadAsset<HLSLFile>(
