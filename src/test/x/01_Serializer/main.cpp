...
struct D {
  std::vector<C> v_vec;
  std::vector<MyDRefl::SharedObject> v_vec_obj;
  std::tuple<C, C> v_t;
...
int main() {
  ...
  {
    MyDRefl::Mngr.RegisterType<C>();

    MyDRefl::Mngr.AddField<&C::asset>("asset");
    C c{.asset = asset};
  ...
  {
    MyDRefl::Mngr.RegisterType<D>();
    MyDRefl::Mngr.AddField<&D::v_vec>("v_vec");
    MyDRefl::Mngr.AddField<&D::v_vec_obj>("v_vec_obj");
    MyDRefl::Mngr.AddField<&D::v_t>("v_t");
    MyDRefl::Mngr.AddField<&D::v_v0>("v_v0");
    MyDRefl::Mngr.AddField<&D::v_v1>("v_v1");
    MyDRefl::Mngr.AddField<&D::v_o0>("v_o0");
    MyDRefl::Mngr.AddField<&D::v_o1>("v_o1");
    MyDRefl::Mngr.AddField<&D::v_vecf3>("v_vecf3");
    D d{.v_vec = {C{asset}, C{asset}},
        .v_t = {C{asset}, C{asset}},
        .v_v0 = {C{asset}},
        .v_v1 = {1},
        .v_o0 = {C{asset}},
  ...
  {
    MyDRefl::Mngr.RegisterType<F>();

    MyDRefl::Mngr.AddField<&F::v_m>("v_m");
    MyDRefl::Mngr.AddField<&F::v_s>("v_s");
    F f{.v_m = {{"123", 3}, {"456", 2}}, .v_s = {"aa", "bb", "cc"}};
