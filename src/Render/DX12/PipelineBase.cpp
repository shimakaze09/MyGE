...
void PipelineBase::SetPSODescForRenderState(
  ...
  if (renderState.blendState.enable) {
    ...
    desc.BlendState.RenderTarget[0].SrcBlend =
        static_cast<D3D12_BLEND>(renderState.blendState.src);
    desc.BlendState.RenderTarget[0].DestBlend =
        static_cast<D3D12_BLEND>(renderState.blendState.dest);
    desc.BlendState.RenderTarget[0].BlendOp =
        static_cast<D3D12_BLEND_OP>(renderState.blendState.op);
    desc.BlendState.RenderTarget[0].SrcBlendAlpha =
        static_cast<D3D12_BLEND>(renderState.blendState.srcAlpha);
    desc.BlendState.RenderTarget[0].DestBlendAlpha =
        static_cast<D3D12_BLEND>(renderState.blendState.destAlpha);
    desc.BlendState.RenderTarget[0].BlendOpAlpha =
        static_cast<D3D12_BLEND_OP>(renderState.blendState.opAlpha);
  }
