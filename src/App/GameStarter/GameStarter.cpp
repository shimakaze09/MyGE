...
void GameStarter::BuildWorld() {
  ...
  //         // transform
  //         My::MyGE::Children, My::MyGE::LocalToParent,
  //         My::MyGE::LocalToWorld, My::MyGE::Parent, My::MyGE::Rotation,
  //         My::MyGE::RotationEuler, My::MyGE::Scale,
  //         My::MyGE::NonUniformScale, My::MyGE::Translation,
  //         My::MyGE::WorldToLocal>();
  // OutputDebugStringA(My::MyGE::Serializer::Instance().Serialize(&world).c_str());
  auto scene = My::MyGE::AssetMngr::Instance().LoadAsset<My::MyGE::WorldAsset>(
