...
bool IsFolderLeaf(const xg::Guid& folderGuid) {
  ...
  for (const auto& child : target->second) {
    if (std::filesystem::is_directory(
            AssetMngr::Instance().GUIDToAssetPath(child)))
      return false;
  }
...
bool IsParentFolder(const std::filesystem::path& x,
...
void ProjectViewerSystemPrintChildren(ProjectViewer* viewer,
                                      const xg::Guid& guid) {
...
void ProjectViewerSystemPrintFolder(Inspector* inspector,
  ...
  auto file = AssetMngr::Instance().LoadAsset<Texture2D>(
      L"..\\assets\\_internal\\FolderViewer\\textures\\file.tex2d");
  auto folder = AssetMngr::Instance().LoadAsset<Texture2D>(
      L"..\\assets\\_internal\\FolderViewer\\textures\\folder.tex2d");
  auto code = AssetMngr::Instance().LoadAsset<Texture2D>(
      L"..\\assets\\_internal\\FolderViewer\\textures\\code.tex2d");
  auto image = AssetMngr::Instance().LoadAsset<Texture2D>(
      L"..\\assets\\_internal\\FolderViewer\\textures\\image.tex2d");
  auto material = AssetMngr::Instance().LoadAsset<Texture2D>(
      L"..\\assets\\_internal\\FolderViewer\\textures\\material.tex2d");
  auto shader = AssetMngr::Instance().LoadAsset<Texture2D>(
      L"..\\assets\\_internal\\FolderViewer\\textures\\shader.tex2d");
  auto hlsl = AssetMngr::Instance().LoadAsset<Texture2D>(
      L"..\\assets\\_internal\\FolderViewer\\textures\\hlsl.tex2d");
  auto scene = AssetMngr::Instance().LoadAsset<Texture2D>(
      L"..\\assets\\_internal\\FolderViewer\\textures\\scene.tex2d");
